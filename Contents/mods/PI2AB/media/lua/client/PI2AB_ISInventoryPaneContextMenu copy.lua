...
--     -- local completedAction = completeAction
--     -- if PI2AB.WhenToTransferItems == 'AfterEach' then
--     --     local result = PI2ABCore.PutInBagRecipe(playerObj,playerInv,selectedItemContainer,targetContainer,completeAction, recipe)
...
--             -- if PI2AB.WhenToTransferItems == 'AtEnd' then
--             --     PI2ABCore.PutInBagRecipe(playerObj,playerInv,selectedItemContainer,targetContainer,completeAction, recipe)
--             -- end
--             return
--         end
