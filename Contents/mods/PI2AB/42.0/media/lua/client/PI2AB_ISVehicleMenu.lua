        ...
        if comparer then
            ...
            for i = 0, itemsToTransfer:size() - 1 do
                ...
                if destinationContainer then
                    local tAction = ISInventoryTransferAction:new(playerObj, it,
                        ISInventoryPage.GetFloorContainer(playerNum), destinationContainer, nil)
