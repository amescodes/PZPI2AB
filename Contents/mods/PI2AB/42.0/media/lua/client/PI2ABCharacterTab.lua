...
function ISCharacterPI2AB:createChildren()
    ...
    -- OPTIONS LABEL
    if self.titleLabel then self:removeChild(self.titleLabel) end
    self.titleLabel = ISLabel:new(self.textX, self.textY, MEDIUM_FONT_HGT, getText("UI_PI2ABTitle"), 1, 1, 1, 1, UIFont.Medium, true)
	self.titleLabel:initialise()
	self.titleLabel:instantiate()
	self:addChild(self.titleLabel)

    self.textY = self.titleLabel:getBottom() + 10
